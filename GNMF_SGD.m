function [U_final, V_final, nIter_final, objhistory_final] = GNMF_SGD(X, k, W, options, U, V)
...
switch lower(options.Optimization)
    case {lower('Multiplicative')} 
        [U_final, V_final, nIter_final, objhistory_final] = GNMF_Multi_SGD_ZU(X, k, W, options, U, V);
    otherwise
